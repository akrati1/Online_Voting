...
<input type="text"  size="20" name="aname" class="input-field" placeholder="Admin Name" title="Enter Valid Admin Name only alphabets are allowed" autocomplete="off" required>
<input type="password" pattern="[A-z a-z 0-9]{5,10}" size="10" name ="apass" class="input-field" placeholder="Enter Password" title="Enter at least 5-letter and max 10-letter password :Don't use special characters " required>
