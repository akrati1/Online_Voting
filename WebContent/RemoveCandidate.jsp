...
<div class="form-box2">
<center  style="#6e0107;"><h1 id="removecandidate">remove Candidate record  </h1></center>
<h2 >Welcome to online Voting System</h2>
<form method="post"    action="AdminRemCand.jsp">
...
<button type="submit" class="submit-btn">Remove Candidate</button>
</form>
